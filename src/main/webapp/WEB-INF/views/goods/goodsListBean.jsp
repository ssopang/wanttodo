...
document.addEventListener('DOMContentLoaded', function() {
    ...
    beansTab.addEventListener('click', function(event) {
        ...
        // 페이지 1번으로 강제 이동
        window.location.href = '${contextPath}/goods/goodsListBean.do?goods_category=원두&pageNum=1';
    });
});
        ...
        if (searchQuery === '') {
            ...
            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link title1" id="beans-tab" href="${contextPath}/goods/goodsListBean.do?goods_category=원두" role="tab" aria-controls="beans" aria-selected="true">원두</a>&nbsp;&nbsp;&nbsp;&nbsp;
                </li>
                <li class="nav-item" role="presentation">
...
<ul class="pagination">
    <c:forEach var="page" begin="1" end="10" step="1">
        ...
        <li class="page-item">
            <a class="page-link" href="${contextPath}/goods/goodsListBean.do?goods_category=원두&section=${section-1}&pageNum=${(section-1)*10 + 1}">&laquo;</a>
       </li>
        </c:if>

        <!-- 현재 페이지 번호 -->
         <li class="page-item">
        <a class="page-link" href="${contextPath}/goods/goodsListBean.do?goods_category=원두&section=${section}&pageNum=${(section-1)*10 + page}">${(section-1)*10 + page}</a>
 		</li>
        <!-- 다음 페이지 링크 -->
        <c:if test="${page == 10}">
        <li class="page-item">
            <a class="page-link" href="${contextPath}/goods/goodsListBean.do?goods_category=원두&section=${section+1}&pageNum=${section*10 + 1}">&raquo;</a>
        </li>
        </c:if>
    </c:forEach>
    </ul>
