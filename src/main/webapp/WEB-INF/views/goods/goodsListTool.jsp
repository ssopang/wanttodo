...
document.addEventListener('DOMContentLoaded', function() {
    ...
    coffeeTab.addEventListener('click', function(event) {
        ...
        // 페이지 1번으로 강제 이동
        window.location.href = '${contextPath}/goods/goodsListTool.do?goods_category=커피용품&pageNum=1';
    });
});
        ...
        if (searchQuery === '') {
            ...
            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                   ...
                   <a class="nav-link title1" id="coffee-tab"href="${contextPath}/goods/goodsListTool.do?goods_category=커피용품" role="tab" aria-controls="coffee" aria-selected="false">커피 용품</a>
                </li>
                        ...
                        <div class="book card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    <span class="new-price">  <fmt:formatNumber  value="${goods.goods_sales_price}" pattern="#,###"/>원</span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<ul class="pagination">
    <c:forEach var="page" begin="1" end="10" step="1">
        ...
        <li class="page-item">
            <a class="page-link" href="${contextPath}/goods/goodsListTool.do?goods_category=커피용품&section=${section-1}&pageNum=${(section-1)*10 + 1}">&laquo;</a>
       </li>
        </c:if>

        <!-- 현재 페이지 번호 -->
         <li class="page-item">
        <a class="page-link" href="${contextPath}/goods/goodsListTool.do?goods_category=커피용품&section=${section}&pageNum=${(section-1)*10 + page}">${(section-1)*10 + page}</a>
 		</li>
        <!-- 다음 페이지 링크 -->
        <c:if test="${page == 10}">
        <li class="page-item">
            <a class="page-link" href="${contextPath}/goods/goodsListTool.do?goods_category=커피용품&section=${section+1}&pageNum=${section*10 + 1}">&raquo;</a>
        </li>
        </c:if>
    </c:forEach>
    </ul>
