...
<body>
	...
	<div class="container">
		...
		<!-- 수정 폼 -->
		<form action="${contextPath}/recipe/updateRecipe.do" method="post"	enctype="multipart/form-data">
				...
				<tbody>
					...
					<tr>
						...
						<td><input type="text" name="title"
							value="${recipe.recipe_title}" placeholder="제목을 입력하세요" required />
						</td>
					</tr>
					<!-- 작성자 -->
					<tr>
						...
						<td><input type="text" name="mem_id"
							value="${recipe.mem_id}" disabled /></td>
					</tr>

					<!-- 내용 -->
					<tr>
						<th>내용<span class="validation">*</span></th>
						<td><textarea name="recipe_content" placeholder="내용을 입력하세요" required>${recipe.recipe_content}</textarea>
						</td>
					</tr>
					<tr>
						<th>상품</th>
						<td>
						<input type="text" name="goods_name" value="${recipe.goods_name}" disabled />
						</td>
					</tr>
					<!-- 이미지 첨부 -->
					<tr>
                ...
                <c:forEach var="image" items="${recipeImages}">
                    <div class="image-preview">
                        ...
                        <div class="checkbox-container">
                            <input type="checkbox" name="deleteImage" value="${image.fileName}" id="delete_${image.fileName}" />
                            <label for="delete_${image.fileName}"> 삭제</label>
                        </div>
                    </div>
                </c:forEach>
            </c:if>
					...
					<tr>
						...
						<td><input type="text"
							value="${recipe.recipe_writedate}" disabled /></td>
					</tr>

					<!-- 조회수 -->
					<tr>
						<th>조회수</th>
						<td><input type="text" value="${recipe.views}" disabled />
						</td>
					</tr>
