     ...
     // 맛/향에 따른 세부 분류 데이터를 미리 준비
        ...
        function updateFieldsBasedOnCategory() {
            ...
            if (selectedCategory === "원두") {
                fieldsContainer.innerHTML = ` 
                	<input type="hidden" name="goods_status" value="N" />
                    <tr>          
                        <td>원두이름<span>*</span></td>
                        <td><input name="goods_name" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    <tr>
                        <td>맛/향<span>*</span></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input name="goods_price" type="text" class="form-control form-control-sm" size="40" oninput="calculateDiscountAndPoint()" onkeypress="return isNumberKey(event)" /></td>
                    </tr>
                    <tr>
                        <td>제품할인가격</td>
                        <td><input name="goods_sales_price" type="text" class="form-control form-control-sm" size="40" readonly/></td>
                    </tr>
                    <tr>
                        <td>제품 구매 포인트</td>
                        <td><input name="goods_point" type="text" class="form-control form-control-sm" size="40" readonly/></td>
                    </tr>
                    <tr>
                        <td>로스팅 날짜</td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="radio" name="goods_c_blending" value="N" id="blending_n" checked />
                    ...
                    <tr>
                        ...
                        <td><input name="goods_origin1" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    <tr>
                        <td>원산지2</td>
                        <td><input name="goods_origin2" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    <tr>
                        <td>원산지3</td>
                        <td><input name="goods_origin3" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    <tr>
                        <td>그램수<span>*</span></td>
                        <td><input name="goods_c_gram" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    <tr>
                ...
                fieldsContainer.innerHTML = ` 
                	<input type="hidden" name="goods_status" value="Y" />
                    <tr>
                        <td>빵이름<span>*</span></td>
                        <td><input name="goods_name" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    ...
                    <tr>
                        <td>제품할인가격</td>
                        <td><input name="goods_sales_price" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    <tr>
                        <td>제품 구매 포인트</td>
                        <td><input name="goods_point" type="text" class="form-control form-control-sm" size="40" /></td>
                    </tr>
                    <tr>
                        <td>재고 수량<span>*</span></td>
                        <td><input name="goods_stock" type="text" class="form-control form-control-sm" size="40" /></td>
            ...
            // 동적으로 추가된 맛/향 요소가 존재하면 기본값(과일)에 따른 세부 분류 업데이트
            if(document.getElementById("goods_c_note")) {
                updateSubcategory();
            }
        }
        ...
        <div id="wrap">
            <article>
                ...
                <form action="${contextPath}/admin/goods/addNewGoods.do" method="post" enctype="multipart/form-data">
                    <h1 class="text-center">새상품 등록창</h1>
                    <div class="tab-container">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="tab4" role="tabpanel" aria-labelledby="tab4-tab">
                                <table class="table">
                                    <tr>
                                        <td class="product-image-text">상품 이미지<span>*</span></td>
                                        <td id="d_file">
