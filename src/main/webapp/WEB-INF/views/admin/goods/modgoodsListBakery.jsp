...
document.addEventListener('DOMContentLoaded', function() {
    ...
    bakeryTab.addEventListener('click', function(event) {
        ...
        // 페이지 1번으로 강제 이동
        window.location.href = '${contextPath}/admin/goods/modgoodsListBakery.do?goods_category=베이커리&pageNum=1';
    });
});
        ...
        if (searchQuery === '') {
            ...
            <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link title1" href="${contextPath}/admin/goods/modgoodsListBean.do?goods_category=원두">원두</a>&nbsp;&nbsp;&nbsp;&nbsp;
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link title1" id="bakery-tab" href="${contextPath}/admin/goods/modgoodsListBakery.do?goods_category=베이커리" role="tab" aria-controls="bakery" aria-selected="false">베이커리</a>&nbsp;&nbsp;&nbsp;&nbsp;
                </li>
                <li class="nav-item" role="presentation">
...
<ul class="pagination">
    <c:forEach var="page" begin="1" end="10" step="1">
        ...
        <li class="page-item">
            <a class="page-link" href="${contextPath}/admin/goods/modgoodsListBakery.do?goods_category=베이커리&section=${section-1}&pageNum=${(section-1)*10 + 1}">&laquo;</a>
       </li>
        </c:if>

        <!-- 현재 페이지 번호 -->
         <li class="page-item">
        <a class="page-link" href="${contextPath}/admin/goods/modgoodsListBakery.do?goods_category=베이커리&section=${section}&pageNum=${(section-1)*10 + page}">${(section-1)*10 + page}</a>
 		</li>
        <!-- 다음 페이지 링크 -->
        <c:if test="${page == 10}">
        <li class="page-item">
            <a class="page-link" href="${contextPath}/admin/goods/modgoodsListBakery.do?goods_category=베이커리&section=${section+1}&pageNum=${section*10 + 1}">&raquo;</a>
        </li>
        </c:if>
    </c:forEach>
    </ul>
