		...
		<div class="header">
			<%@ include file="../common/header.jsp" %>
					...
					<div class="container mt-5 container-custom">
					    <h3 class="text-center">배송지 정보 수정</h3>
					    <br>
					    <br>
					    <form name="modaddress" action="${contextPath}/address/modAddress.do" method="post" onsubmit="return check_modAddress();">
					    <div class="row mb-3">
					    <label class="col-sm-3 col-form-label req">배송지 번호</label>
					    <div class="col-sm-5">
					        <input type="text" id="address_id" name="address_id" class="form-control" style="height: 38px;" value="${address_id}" readonly/>
					    </div>
					</div>
					    <div class="row mb-3">
					...
					<div class="row mb-3">
					    ...
					    <div class="col-sm-5">
					        <input type="text" id="mem_add3" name="mem_add3" class="form-control" placeholder="나머지 주소" size="50"/>
					    </div>
					</div>
