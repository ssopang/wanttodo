...
<c:set var="toReviews" value="${reviewsMap.toReviews}" />
<!DOCTYPE html>
<html>
<head>
...
<div class="container">
        ...
        <c:forEach var="review"  varStatus="reviewNum" items="${reviewList}">
            <div class="review-item">
               ...
               <div class="review-title">
                ...
                <p style="display: block; margin-right: 10px;">  <fmt:formatDate value="${review.review_writedate}" pattern="yyyy-MM-dd HH:mm"/></p>
                <p>조회 : ${review.views}</p>
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            <c:if test="${toReviews != null}">
                <c:forEach var="page" begin="1" end="10" step="1">
                    <c:if test="${section > 1 && page == 1}">
                        <li class="page-item"><a class="page-link" href="${contextPath }/review/reviewLists.do?section=${section-1}&pageNum=${(section-1)*10 +1 }">&laquo;</a></li>
                    </c:if>
                    <li class="page-item"><a class="page-link" href="${contextPath }/review/reviewLists.do?section=${section}&pageNum=${page}">${(section-1)*10 +page }</a></li>
                    <c:if test="${page == 10}">
                        <li class="page-item"><a class="page-link" href="${contextPath }/review/reviewLists.do?section=${section+1}&pageNum=${section*10+1}">&raquo;</a></li>
                    </c:if>
                </c:forEach>
            </c:if>
        </ul>
